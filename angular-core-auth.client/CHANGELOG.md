...
- Create Angular project with ng: `ng new angular-core-auth.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`angular-core-auth.client.esproj`).
